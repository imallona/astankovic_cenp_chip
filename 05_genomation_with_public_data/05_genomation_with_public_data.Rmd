...
multiHeatMatrix(sml_with_cpg,
                xcoords = c(-2000, 1000), clustfun = function(x) kmeans(x, centers = 3)$cluster)
```
...
legend('topright', legend = names(sml.scaled), col = as.numeric(as.factor(names(sml.scaled))),
       pch =1) 
```
...
```{r gse_loop, eval = TRUE, fig.width = 30, fig.height = 10, results = 'asis'}
PUBLIC <- '/home/imallona/cenp_chip/public/'
