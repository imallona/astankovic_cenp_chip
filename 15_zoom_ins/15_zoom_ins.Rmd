...
zoom_sml <- ScoreMatrixList(covs, zoomed_proms, bin.num = 100, type = "bam", param = param,
                       strand.aware = TRUE)
...
zoom_sml <- ScoreMatrixList(covs, zoomed_proms, bin.num = 200, type = "bam", param = param,
                       strand.aware = TRUE)
...
zoom_sml <- ScoreMatrixList(covs, zoomed_proms, bin.num = 50, type = "bam", param = param,
                       strand.aware = TRUE)
