...
sml_genes_with_cpg_idx <- as.numeric(dimnames(sml_genes_with_cpg@.Data[[1]])[[1]])
...
sml_genes_scaled_with_cpg <- intersectScoreMatrixList(ScoreMatrixList(c(sml_genes_scaled, sm_cpgi,
                                ...
                                cores = NTHREADS)),
                                reorder = TRUE)
sml_genes_scaled_with_cpg_idx <- as.numeric(dimnames(sml_genes_scaled_with_cpg@.Data[[1]])[[1]])
...
multiHeatMatrix(sml_genes_with_cpg,
                ...
                user.order = 1:5,
                clustfun = clu[as.character(sml_genes_with_cpg_idx)],
                order = TRUE)
```
...
multiHeatMatrix(sml_genes_scaled_with_cpg,
                group.col = c('forestgreen', 'blue', 'red', 'black', 'orange'),
                user.order = 1:5,
                clustfun = clu_scaled[as.character(sml_genes_scaled_with_cpg_idx)],  
                xcoords = c(minx, maxx),
                order = TRUE)
```
...
set.seed(1)
multiHeatMatrix(sml_genes_with_cpg,
                xcoords = c(minx, maxx), clustfun = clu[sml_genes_with_cpg_idx],
                  group.col = c('forestgreen', 'blue', 'red', 'black', 'orange'),
                user.order = 1:5,
                order = TRUE)
...
set.seed(1)
multiHeatMatrix(sml_genes_scaled_with_cpg,
                xcoords = c(minx, maxx), clustfun = clu_scaled[sml_genes_scaled_with_cpg_idx],
                  group.col = c('forestgreen', 'blue', 'red', 'black', 'orange'),
                user.order = 1:5,
                order = TRUE)
set.seed(1)
...
sml_genes_scaled_with_cpg_edge_idx <- as.numeric(dimnames(sml_genes_with_cpg_edge@.Data[[1]])[[1]])

max(sml_genes_scaled_with_cpg_edge_idx)
...
multiHeatMatrix(sml_genes_with_cpg_edge,
                xcoords = c(minx, maxx),
                clustfun = clu[as.character(sml_genes_scaled_with_cpg_edge_idx)],
                group.col = c('forestgreen', 'blue', 'red', 'black', 'orange'),
                user.order = 1:5,
                order = TRUE,
                col = viridis(9),
