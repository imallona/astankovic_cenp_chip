...
for (quant in c(0.5, 0.8, 0.9, 0.95, 0.99)) {
    ...
    ## rm_grobs <- gt$layout$name %in% c("panel-1-2", "panel-1-3",
    ##                                   "strip-t-1-2", "strip-t-1-3",
    ##                                   "axis-l-1-2", "axis-l-1-3",
    ##                                   "axis-r-1-2", "axis-r-1-3",
    ##                                   "axis-b-1-2",
    ##                                   "axis-t-1-2", "axis-t-1-3",
    ##                                   "axis-l-2-1", "axis-l-2-1",
    ##                                   "axis-l-3-1", "axis-l-3-1")

    ## gt$heights[17] <- unit(0, "cm")
...
multiHeatMatrix(harmonize_sml(tmp_selected, clu[tmp_idx]),
                xcoords = c(minx, maxx),
                group = foo,
                order = TRUE,
                winsorize = c(1,99),
