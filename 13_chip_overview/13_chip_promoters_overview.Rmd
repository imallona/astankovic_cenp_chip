...
for (item in 'genes_proms') { # c('all_proms', 'genes_proms', 'tsss', 'genes_asis')) {
    gr <- get(item)
...
```{r}
sml_proms <- ScoreMatrixList(covs, windows = genes_proms,
...
mat.list = lapply(sml_proms, function(x) x@.Data)
    group.vector = NULL
...
sml_proms_scaled <- scaleScoreMatrixList(sml_proms)

mat.list = lapply(sml_proms_scaled, function(x) x@.Data)
    group.vector = NULL
...
set.seed(1)
multiHeatMatrix(sml_proms, xcoords = c(0, 100),
                group = as.factor(clu),
                order = TRUE)
...
sml_proms_with_cpg <- intersectScoreMatrixList(ScoreMatrixList(c(sml_proms, sm_cpgi),
...
sml_proms_with_cpg_idx <- dimnames(sml_proms_with_cpg@.Data[[1]])[[1]]
max(sml_proms_with_cpg_idx)
length(sml_proms_with_cpg_idx)
sml_proms_with_cpg
...
names(sml_proms_with_cpg)[length(names(sml_proms_with_cpg))] <- 'CpGi'
```


```{r}
sml_proms_scaled_with_cpg <- intersectScoreMatrixList(ScoreMatrixList(c(sml_proms_scaled, sm_cpgi,
                                genes_proms, bin.num = 100,
                                strand.aware = TRUE,
                                cores = NTHREADS)),
                                reorder = TRUE)
sml_proms_scaled_with_cpg_idx <- dimnames(sml_proms_scaled_with_cpg@.Data[[1]])[[1]]
...
names(sml_proms_scaled_with_cpg)[length(names(sml_proms_scaled_with_cpg))] <- 'CpGi'
```
...
```{r, fig.width = 8, fig.height = 6}
set.seed(1)
multiHeatMatrix(sml_proms_with_cpg,
                xcoords = c(minx, maxx),
                group.col = c('forestgreen', 'blue', 'red', 'black', 'orange'),
                ## user.order = 1:5,
                group = as.factor(clu[sml_proms_with_cpg_idx]),
                order = TRUE)
```
...
multiHeatMatrix(sml_proms_with_cpg,
                ...
                group.col = c('forestgreen', 'blue', 'red', 'black', 'orange'),
                ## user.order = 1:5,
                group = as.factor(clu[as.character(sml_proms_with_cpg_idx)]),
...
set.seed(1)
multiHeatMatrix(sml_proms_scaled, xcoords = c(minx, maxx),
                group.col = c('forestgreen', 'blue', 'red', 'black', 'orange'),
                ## user.order = 1:5,
                group = as.factor(clu),                
                order = TRUE)
...
```{r, fig.width = 8, fig.height = 6}
set.seed(1)
multiHeatMatrix(sml_proms_scaled_with_cpg,
                group.col = c('forestgreen', 'blue', 'red', 'black', 'orange'),
                ## user.order = 1:5,
                group = as.factor(clu_scaled[sml_proms_scaled_with_cpg_idx]),  
                xcoords = c(minx, maxx),
                order = TRUE)
```
...
multiHeatMatrix(sml_proms_scaled_with_cpg,
                ...
                group.col = c('forestgreen', 'blue', 'red', 'black', 'orange'),
                ## user.order = 1:5,
                group = as.factor(clu_scaled[as.character(sml_proms_scaled_with_cpg_idx)]),
                col = brewer.pal(15,"Blues"),
                order = TRUE)
```
...
par(pty = 's')
plotMeta(sml_proms, profile.names = names(sml_proms),
         meta.rescale = FALSE,
         lwd = 2,
         smoothfun = NULL,
                  centralTrend = 'mean',
...
```{r, fig.width = 5, fig.height = 4}
par(pty = 's')
plotMeta(sml_proms_with_cpg, profile.names = names(sml_proms_with_cpg),
         meta.rescale = TRUE,
         lwd = 2,
         smoothfun = NULL,
                  centralTrend = 'mean',
...
set.seed(1)
test <- lapply(sml_proms, function(x) return(x@.Data))
...
```{r, fig.width = 10, fig.height = 8}
set.seed(1)
test <- lapply(sml_proms, function(x) return(val2unit(x@.Data)))
...
test %>% group_by(sample, cluster, pos) %>% 
    ...
    facet_wrap(~cluster) +
    theme_bw() +
    scale_x_continuous(breaks = c(0, 100), labels = c('-2kb', '+1kb'))
...
set.seed(1)
multiHeatMatrix(sml_proms_scaled,
                xcoords = c(minx, maxx),
...
```{r, fig.width = 10, fig.height = 8}
set.seed(1)
test <- lapply(sml_proms_scaled, function(x) return(val2unit(x@.Data)))
...
<!--     for (id in names(sml_proms)) { -->
<!--         chopped[[as.character(i)]][[id]] <- sml_proms[[id]] -->

<!--         if (sum(clu == i) > 1) { -->
            
<!--             chopped[[as.character(i)]][[id]]@.Data <- sml_proms[[id]]@.Data[clu == i,] -->
<!--         } -->
<!--         else { -->
<!--             ## chopped[[as.character(i)]][[id]]@dimnames[[1]] <- 1:2 -->
<!--             tmp <- as.matrix( -->
<!--                 rbind(sml_proms[[id]]@.Data[clu == i,], -->
<!--                       sml_proms[[id]]@.Data[clu == i,])) -->
...
set.seed(1)
test <- lapply(sml_proms_with_cpg, function(x) return(x@.Data))

for (item in names(test)) {
    fd <- as.data.frame(test[[item]])
    fd$window <- 1:nrow(fd)

    fd$cluster <- paste0('cluster ', clu[as.character(sml_proms_with_cpg_idx)])
    fd$sample <- item
    ## colnames(fd) <- paste0('pos', colnames(fd))
    head(fd)
    fd <- as.data.frame(fd) %>% 
...
set.seed(1)
test <- lapply(sml_proms_with_cpg, function(x) return(val2unit(x@.Data)))
...
```{r,fig.width = 6, fig.height = 6}
set.seed(1)
test <- lapply(sml_proms_scaled_with_cpg, function(x) return(val2unit(x@.Data)))

for (item in names(test)) {
    fd <- as.data.frame(test[[item]])
    fd$window <- 1:nrow(fd)
    fd$cluster <- paste0('cluster ', clu_scaled[sml_proms_scaled_with_cpg_idx])
    fd$sample <- item
    ## colnames(fd) <- paste0('pos', colnames(fd))
    head(fd)
    fd <- as.data.frame(fd) %>% 
...
edge <- ScoreMatrixList(edge_sm, windows = genes_proms, bin.num = 100, cores = NTHREADS)
## edge
```
...
<!-- sml_proms_with_cpg_edge <- intersectScoreMatrixList(ScoreMatrixList(c(sml_proms_with_cpg, edge), -->
<!--                                 genes_proms, bin.num = 100, -->
<!--                                 strand.aware = TRUE, -->
<!--                                 cores = NTHREADS), -->
<!--                                 reorder = TRUE) -->

<!-- sml_proms_with_cpg_edge_idx <- dimnames(sml_proms_with_cpg_edge@.Data[[1]])[[1]] -->
<!-- ## length(sml_proms_with_cpg_edge_idx) -->
<!-- ## max(as.numeric(sml_proms_with_cpg_edge_idx)) -->


<!-- sml_proms_scaled_with_cpg_edge <- intersectScoreMatrixList(ScoreMatrixList(c(sml_proms_scaled_with_cpg, edge), -->
<!--                                 genes_proms, bin.num = 100, -->
<!--                                 strand.aware = TRUE, -->
<!--                                 cores = NTHREADS), -->
<!--                                 reorder = TRUE) -->

<!-- sml_proms_scaled_with_cpg_edge_idx <- dimnames(sml_proms_scaled_with_cpg_edge@.Data[[1]])[[1]] -->


<!-- ## length(sml_proms_scaled_with_cpg_edge_idx) -->
<!-- ## max(as.numeric(sml_proms_scaled_with_cpg_edge_idx)) -->

<!-- ## table(clu[as.character(sml_proms_with_cpg_edge_idx)]) -->
<!-- ## table(clu) -->

<!-- set.seed(1) -->
<!-- multiHeatMatrix(sml_proms_with_cpg_edge, -->
<!--                 xcoords = c(minx, maxx), -->
<!--                 group = as.factor(clu[as.character(sml_proms_with_cpg_edge_idx)]), -->
<!--                 group.col = c('forestgreen', 'blue', 'red', 'black', 'orange'), -->
<!--                 ## user.order = 1:5, -->
<!--                 order = TRUE, -->
<!--                 winsorize = c(1,99), -->
...
<!-- ## set.seed(1) -->
<!-- ## multiHeatMatrix(harmonize_sml(sml_proms_with_cpg_edge, clu[as.character(sml_proms_with_cpg_edge_idx)]), -->
<!-- ##                 xcoords = c(minx, maxx), -->
<!-- ##                 group = as.factor(clu[as.character(sml_proms_with_cpg_edge_idx)]), -->
<!-- ##                 group.col = c('forestgreen', 'blue', 'red', 'black', 'orange'), -->
<!-- ##                 ## user.order = 1:5, -->
...
<!-- ## set.seed(1) -->
<!-- ## multiHeatMatrix(harmonize_sml(sml_proms_with_cpg, clu[as.character(sml_proms_with_cpg_edge_idx)]), -->
<!-- ##                 xcoords = c(minx, maxx), -->
<!-- ##                 clustfun = clu[as.character(sml_proms_with_cpg_edge_idx)], -->
<!-- ##                 group.col = c('forestgreen', 'blue', 'red', 'black', 'orange'), -->
<!-- ##                 ## user.order = 1:5, -->
<!-- ##                 order = FALSE, -->
<!-- ##                 winsorize = c(1,99), -->
...
<!-- ## multiHeatMatrix(harmonize_sml(sml_proms, clu[as.character(sml_proms_with_cpg_edge_idx)]), -->
<!-- ##                 xcoords = c(minx, maxx), -->
<!-- ##                 group = as.factor(clu[as.character(sml_proms_with_cpg_edge_idx)]), -->
<!-- ##                 group.col = c('forestgreen', 'blue', 'red', 'black', 'orange'), -->
<!-- ##                 ## user.order = 1:5, -->
...
<!-- set.seed(1) -->
<!-- test <- lapply(sml_proms_with_cpg_edge, function(x) return(val2unit(x@.Data))) -->

<!-- for (item in names(test)) { -->
<!--     fd <- as.data.frame(test[[item]]) -->
<!--     fd$window <- 1:nrow(fd) -->
<!--     fd$cluster <- paste0('cluster ', clu[as.character(sml_proms_with_cpg_edge_idx)]) -->
<!--     fd$sample <- item -->
<!--     ## colnames(fd) <- paste0('pos', colnames(fd)) -->
<!--     head(fd) -->
<!--     fd <- as.data.frame(fd) %>%  -->
...
<!-- ### With scaled CENPa and CpGi  {.tabset .tabset-pills} -->
...
<!-- ```{r, fig.width = 12, fig.height = 4} -->
<!-- set.seed(1) -->
<!-- multiHeatMatrix(c(sml_proms_scaled_with_cpg_edge, bin.num = 100, windows = genes_proms), -->
<!--                 xcoords = c(minx, maxx), -->
<!--                 group = as.factor(clu_scaled[as.character(sml_proms_scaled_with_cpg_edge_idx)]), -->
<!--                 group.col = c('forestgreen', 'blue', 'red', 'black', 'orange'), -->
<!--                 ## user.order = 1:5, -->
<!--                 order = TRUE, -->
<!--                 winsorize = c(1,99), -->
...
<!-- ```{r, fig.width = 10, fig.height = 6} -->
<!-- set.seed(1) -->
<!-- test <- lapply(sml_proms_scaled_with_cpg_edge, function(x) return(val2unit(x@.Data))) -->

<!-- for (item in names(test)) { -->
<!--     fd <- as.data.frame(test[[item]]) -->
<!--     fd$window <- 1:nrow(fd) -->
<!--     fd$cluster <- paste0('cluster ', clu_scaled[sml_proms_scaled_with_cpg_edge_idx]) -->
<!--     fd$sample <- item -->
<!--     ## colnames(fd) <- paste0('pos', colnames(fd)) -->
<!--     head(fd) -->
<!--     fd <- as.data.frame(fd) %>%  -->
...
<!--     facet_wrap(~cluster) + -->
<!--     theme_bw() + -->
<!--     scale_x_continuous(breaks = c(0, 100), labels = c('-2kb', '+1kb')) + theme(aspect.ratio=1) -->
...
tmp <- intersectScoreMatrixList(ScoreMatrixList(c(sml_proms_with_cpg, edge),
                                genes_asis, bin.num = 100,
                                strand.aware = TRUE,
                                cores = NTHREADS),
                                reorder = TRUE)
...
tmp <- intersectScoreMatrixList(ScoreMatrixList(c(sml_proms_with_cpg, scaleScoreMatrixList(edge)),
                                genes_asis, bin.num = 100,
                                strand.aware = TRUE,
                                cores = NTHREADS),
                                reorder = TRUE)
...
<!-- (curr <- ScoreMatrixList(c(sml_proms_with_cpg, edge), bin.num = 100, windows = genes_proms)) -->
...
bws <- ScoreMatrixList(bws,  genes_proms, bin.num = 100, strand.aware = TRUE, cores = NTHREADS)
...
tmp <- intersectScoreMatrixList(ScoreMatrixList(c(sml_proms_with_cpg, bws),
                                genes_proms, bin.num = 100,
                                strand.aware = TRUE,
                                cores = NTHREADS),
                                reorder = TRUE)
...
tmp <- intersectScoreMatrixList(ScoreMatrixList(c(sml_proms_with_cpg, scaleScoreMatrixList(bws)),
                                genes_proms, bin.num = 100,
                                strand.aware = TRUE,
                                cores = NTHREADS),
                                reorder = TRUE)
...
tmp <- intersectScoreMatrixList(ScoreMatrixList(c(sml_proms_with_cpg, GSE125068, peaks),
                                                genes_proms,
                                                bin.num = 100,
                                                strand.aware = TRUE,
                                                cores = NTHREADS),
...
tmp <- intersectScoreMatrixList(ScoreMatrixList(c(sml_proms_with_cpg, GSE125068, peaks, bws),
                                                genes_proms,
                                                bin.num = 100,
                                                strand.aware = TRUE,
                                                cores = NTHREADS),
...
tmp <- intersectScoreMatrixList(ScoreMatrixList(c(sml_proms_with_cpg, curr),
                                genes_proms, bin.num = 100,
                                strand.aware = TRUE,
                                cores = NTHREADS),
                                reorder = TRUE)
...
tmp <- intersectScoreMatrixList(ScoreMatrixList(c(sml_proms_with_cpg, scaleScoreMatrixList(curr)),
                                genes_proms, bin.num = 100,
                                strand.aware = TRUE,
                                cores = NTHREADS),
                                reorder = TRUE)
...
tmp <- intersectScoreMatrixList(ScoreMatrixList(c(sml_proms_with_cpg, covs),
                                genes_proms, bin.num = 100,
                                strand.aware = TRUE,
                                cores = NTHREADS),
                                reorder = TRUE)
...
tmp <- intersectScoreMatrixList(ScoreMatrixList(c(sml_proms_with_cpg, scaleScoreMatrixList(covs)),
                                genes_proms, bin.num = 100,
                                strand.aware = TRUE,
                                cores = NTHREADS),
                                reorder = TRUE)
...
set.seed(134)
test %>% group_by(cluster) %>% sample_n(size = 4900) %>% 
...
<!-- mat.list = lapply(c(sml_proms_with_cpg, GSE125068, peaks, lung_liver_cenp, GSE21161), function(x) x@.Data) -->
...
<!-- ```{r} -->
<!-- mat.list = lapply(c(sml_proms_with_cpg, GSE125068, peaks), function(x) x@.Data) -->

<!-- names(mat.list) <- names(c(sml_proms_with_cpg, GSE125068, peaks)) -->
<!-- longer <- list() -->
<!-- for (samp in names(mat.list)) { -->
<!--     ## table(tidyr::pivot_longer(data = as.data.frame(mat.list[[samp]]), cols = 1:ncol(mat.list[[samp]]))$name) -->
<!--     longer[[samp]] <- list() -->
...
<!-- ```{r, fig.width = 10, fig.height = 6} -->
<!-- set.seed(1) -->
<!-- multiHeatMatrix(c(sml_proms_with_cpg, covs), -->
...
<!-- ```{r, fig.width = 10, fig.height = 6} -->
<!-- set.seed(1) -->
<!-- multiHeatMatrix(c(sml_proms_with_cpg, scaleScoreMatrixList(covs)), -->
<!--                 xcoords = c(minx, maxx), clustfun = function(x) kmeans(x, centers = 2)$cluster, -->
<!--                 order = TRUE, -->
<!--                 winsorize = c(1,99), -->
<!--                 col = viridis(9), -->
...
<!-- ```{r} -->
<!-- mat.list = lapply(c(sml_proms_with_cpg, GSE125068, peaks, lung_liver_cenp, GSE21161, GSE69806), function(x) x@.Data) -->

<!-- names(mat.list) <- names(c(sml_proms_with_cpg, GSE125068, peaks, lung_liver_cenp, GSE21161, GSE69806)) -->
<!-- longer <- list() -->
<!-- for (samp in names(mat.list)) { -->
<!--     ## table(tidyr::pivot_longer(data = as.data.frame(mat.list[[samp]]), cols = 1:ncol(mat.list[[samp]]))$name) -->
<!--     longer[[samp]] <- list() -->
...
<!-- <\!-- set.seed(1) -\-> -->
<!-- <\!-- multiHeatMatrix(c(sml_proms_with_cpg, edge), -\-> -->
<!-- <\!--                 xcoords = c(minx, maxx), clustfun = function(x) kmeans(x, centers = 2)$cluster, -\-> -->
<!-- <\!--                 order = TRUE, -\-> -->
<!-- <\!--                 col = viridis(9), -\-> -->
<!-- <\!--                 clust.matrix = 1:4, -\-> -->
...
<!-- <\!-- set.seed(1) -\-> -->
<!-- <\!-- multiHeatMatrix(c(sml_proms_with_cpg, scaleScoreMatrixList(edge)), -\-> -->
<!-- <\!--                 xcoords = c(minx, maxx), clustfun = function(x) kmeans(x, centers = 2)$cluster, -\-> -->
<!-- <\!--                 order = TRUE, -\-> -->
<!-- <\!--                 col = viridis(9), -\-> -->
<!-- <\!--                 clust.matrix = 1:4, -\-> -->
...
<!-- <\!-- multiHeatMatrix(c(sml_proms_with_cpg, curr), -\-> -->
<!-- <\!--                 xcoords = c(minx, maxx), clustfun = function(x) kmeans(x, centers = 2)$cluster, -\-> -->
<!-- <\!--                 order = TRUE, -\-> -->
<!-- <\!--                 col = viridis(9), -\-> -->
<!-- <\!--                 clust.matrix = 1:4, -\-> -->
...
<!-- <\!-- set.seed(1) -\-> -->
<!-- <\!-- multiHeatMatrix(c(sml_proms_with_cpg, GSE125068, GSE85873, GSE21161, curr), -\-> -->
<!-- <\!--                 xcoords = c(minx, maxx), clustfun = function(x) kmeans(x, centers = 2)$cluster, -\-> -->
<!-- <\!--                 order = TRUE, -\-> -->
<!-- <\!--                 col = viridis(9), -\-> -->
<!-- <\!--                 clust.matrix = 1:4, -\-> -->
...
<!-- <\!-- ```{r, eval = FALSE} -\-> -->
<!-- <\!-- c(sml_proms_with_cpg, GSE125068, GSE85873, GSE21161) -\-> -->
<!-- <\!-- names(c(sml_proms_with_cpg, GSE125068, GSE85873, GSE21161)) -\-> -->

<!-- <\!-- ## joint <- ScoreMatrixList(list(sml_proms_with_cpg, GSE125068, GSE85873, GSE21161), targets = genes_proms, -\-> -->
<!-- <\!-- ##                          bin.num = 50) -\-> -->

<!-- <\!-- ## c(sml_proms_with_cpg, GSE125068, GSE85873, GSE21161) -\-> -->
<!-- <\!-- ## c(sml_proms_with_cpg, GSE125068, GSE85873, curr) -\-> -->
<!-- <\!-- ## dim(sml[[1]]@.Data) -\-> -->
